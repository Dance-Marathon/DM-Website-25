  ...
  <React.StrictMode>
    <Router>
      <Routes>
        ...
        <Route
          path="/blog/beyondthisgeneration"
          element={<BeyondThisGeneration />}
        />
        <Route
          path="/blog/findingyourdmfamily"
          element={<FindingYourDMFamily />}
        />
        ...
        <Route
          path="/blog/lifelineoflaughter"
          element={<LifelineOfLaughter />}
        />
