...
const images = [
  ...
  { src: Sponsor21, alt: 'Sponsor 21' },
  { src: Sponsor22, alt: 'Sponsor 22' },
  { src: Sponsor23, alt: 'Sponsor 23' },
  { src: Sponsor24, alt: 'Sponsor 24' },
  { src: Sponsor25, alt: 'Sponsor 25' },
  { src: Sponsor26, alt: 'Sponsor 26' },
  { src: Sponsor27, alt: 'Sponsor 27' },
  { src: Sponsor28, alt: 'Sponsor 28' },
  { src: Sponsor29, alt: 'Sponsor 29' },
  { src: Sponsor30, alt: 'Sponsor 30' },
  { src: Sponsor31, alt: 'Sponsor 31' },
  { src: Sponsor32, alt: 'Sponsor 32' },
  { src: Sponsor33, alt: 'Sponsor 33' },
  { src: Sponsor34, alt: 'Sponsor 34' },
  { src: Sponsor35, alt: 'Sponsor 35' },
  { src: Sponsor36, alt: 'Sponsor 36' },
  { src: Sponsor37, alt: 'Sponsor 37' },
  { src: Sponsor38, alt: 'Sponsor 38' },
  { src: Sponsor39, alt: 'Sponsor 39' },
  { src: Sponsor40, alt: 'Sponsor 40' },
  { src: Sponsor41, alt: 'Sponsor 41' },
  { src: Sponsor42, alt: 'Sponsor 42' },
  { src: Sponsor43, alt: 'Sponsor 43' },
  { src: Sponsor44, alt: 'Sponsor 44' },
  { src: Sponsor45, alt: 'Sponsor 45' },
  { src: Sponsor46, alt: 'Sponsor 46' },
  { src: Sponsor47, alt: 'Sponsor 47' },
  { src: Sponsor48, alt: 'Sponsor 48' },
  { src: Sponsor49, alt: 'Sponsor 49' },
  { src: Sponsor50, alt: 'Sponsor 50' },
  { src: Sponsor51, alt: 'Sponsor 51' },
  { src: Sponsor52, alt: 'Sponsor 52' },
  { src: Sponsor53, alt: 'Sponsor 53' },
  { src: Sponsor54, alt: 'Sponsor 54' },
  { src: Sponsor55, alt: 'Sponsor 55' },
  { src: Sponsor56, alt: 'Sponsor 56' },
  { src: Sponsor57, alt: 'Sponsor 57' },
