  ...
  return (
    <ThemeProvider theme={LPtheme}>
      ...
      >
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
            Check out our {' '}
          <Link href="https://drive.google.com/drive/folders/1xxH_1OT0Y7XDnLcXFz3Q9_ez-_z7hpVN">Canning Resources</Link>!
        </Typography>
        <Typography variant="body1" color="text.secondary" paragraph>
            Fill out our {' '}
          <Link href="https://forms.gle/3nBuQXBxRBtvXwUs5">Canning Interest Form</Link>!
        </Typography>
        <Typography variant="b2"  color="text.secondary" paragraph sx={{mt: 2}}>
        If you have any questions about canning, contact the Finance Overall Director, Tyler Bonnoront at {' '}
        <Link href="mailto:tbonnoront@floridadm.org">tbonnoront@floridadm.org.</Link>
        </Typography>
      </Container>
      <Footer />
    </ThemeProvider>
