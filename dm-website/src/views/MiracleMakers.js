...
export default function MiracleMakers() {
  ...
  return (
    <ThemeProvider theme={LPtheme}>
      ...
      <Typography variant="body1" color="text.secondary">
        Follow the link <Link href="https://events.dancemarathon.com/index.cfm?fuseaction=donorDrive.event&eventID=6292" target="_blank"><strong>here</strong></Link> to register, and a Member Advancement Captain will reach out to you with further details.
      </Typography>
      <Typography variant="body1" color="text.secondary" >
