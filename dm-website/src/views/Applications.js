    ...
    <ThemeProvider theme={LPtheme}>
      ...
      >
        ...
        >
            ...
            <ul>
                <li>
                <Typography variant="body1" sx={{ color: '#000000' }}>Complete the online application form.</Typography>
                </li>
                <li>
                <Typography variant="body1" sx={{ color: '#000000' }}>Create a DonorDrive personal fundraising page.</Typography>
                </li>
                <li>
