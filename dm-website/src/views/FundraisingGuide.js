...
export default function FundraisingGuide() {
  ...
  return (
    <ThemeProvider theme={LPtheme}>
      ...
      {/* Horizontal container for the images */}
        <Box sx={{ margin: '0 10px', textAlign: 'center' }}>
          {/* Image as a button to trigger accordion */}
          <IconButton >
            <img src={HeroPic} alt={"Reaching Out"} width="100%" height="100%" style={{ borderRadius: '8px' }} />
          </IconButton>
          <IconButton >
            <img src={HeroPic} alt={"Fundraising Tips"} width="100%" height="100%" style={{ borderRadius: '8px' }} />
          </IconButton>
          <IconButton >
            <img src={HeroPic} alt={"Canning"} width="100%" height="100%" style={{ borderRadius: '8px' }} />
          </IconButton>
