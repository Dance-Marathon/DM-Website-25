...
export default function FundraisingGuide() {
  ...
  // Define toggleColorMode function
  ...
  const handleExpand = (itemId) => {
    setExpandedItem(expandedItem === itemId ? null : itemId); // Toggle accordion
  };
  ...
  return (
    <ThemeProvider theme={LPtheme}>
      ...
      >
        ...
        {/* Stacked Images and Accordions */}
        <Box display="flex" flexDirection="row" justifyContent="space-between" gap={5}>
          <Box display="flex" flexDirection="column" alignItems="center">
            <Accordion expanded={expandedItem === 1} onChange={() => handleExpand(1)}>
              <AccordionSummary>
                <Box display="flex" flexDirection="column" alignItems="center">
                  <img 
                    src={HeroPic} 
                  ...
                  />
                  <Typography variant="h5" color= '#233563' marginTop={2} marginBottom={-1} gutterBottom>
                    Reaching Out
                  </Typography> {/* Label for the image */}
                </Box>
              </AccordionSummary>
              <AccordionDetails>
          ...
          <Box display="flex" flexDirection="column" alignItems="center">
            <Accordion expanded={expandedItem === 2} onChange={() => handleExpand(2)}>
              <AccordionSummary>
                <Box display="flex" flexDirection="column" alignItems="center">
                  <img 
                    src={HeroPic} 
          ...
          <Box display="flex" flexDirection="column" alignItems="center">
            <Accordion expanded={expandedItem === 3} onChange={() => handleExpand(3)}>
              <AccordionSummary>
                <Box display="flex" flexDirection="column" alignItems="center">
                  <img 
                    src={HeroPic} 
