      ...
      >
        ...
        >
          <Typography variant="b1" color="text.secondary">
            <p>Dance Marathon at the University of Florida is a yearlong philanthropic effort benefiting the patients of UF Health Shands Children's Hospital in Gainesville, Florida. Each year, students stay awake and on their feet at our annual 26.2 hour event to raise funds and awareness for Children's Miracle Network Hospitals for the duration of the event. In the 31 years of Dance Marathon at UF's existence, we have <b style={{ color: '#FFC46E' }}>raised more than $33 million</b>, making it <b style={{ color: '#7E31C8' }}>the most successful student-run philanthropy in the Southeastern United States</b>. In 2024, DM at UF raised a grand total of <b style={{ color: '#FFC46E' }}>$1,351,566.99</b> for UF Health Shands Children's Hospital, our local Children’s Miracle Network Hospital.</p>
            <p>In 2023, UF Health Shands Children's Hosptial treated children from 66 counties in Florida, 49 other states, and 7 other countries. There were 18,586 telehealth visits, 40,408 ER visits, and 359,419 clinic visits. <b style={{ color: '#7E31C8' }}>All of the funds raised by DM at UF go directly to purchasing state-of-the-art medical equipment, enhancements to make the children’s stay at the hospital more enjoyable, and funding for research grants and educational programs</b>.</p>
            ...
            <p><b style={{ color: '#7E31C8' }}>As we head into our <b style={{ color: '#FFC46E' }}>32nd year</b>, Dance Marathon at UF is excited to make even more miracles!</b></p>
          </Typography>
        </Box>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
          ...
          >
            {[
              { image: OurStoryBox, title: 'Our Story', hoverText: "As one of the five founding Dance Marathon programs, DM at UF has raised over $33 million for Miracle Families at UF Health Shands Children’s Hospital", link: '/ourstory' },
