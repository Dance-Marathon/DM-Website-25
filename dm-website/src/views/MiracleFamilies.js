...
import CadenB from "../assets/images/miraclechildren/Caden.jpg";
import CasonT from "../assets/images/miraclechildren/Cason.jpg";
import ClaireE from "../assets/images/miraclechildren/Claire.jpg";
import DaniLynnE from "../assets/images/miraclechildren/Dani Lynn.jpg";
import ElizabethC from "../assets/images/miraclechildren/Elie.jpg";
import EllaR from "../assets/images/miraclechildren/Ella Grace.jpg";
import EleanorZ from "../assets/images/miraclechildren/Eleanor.jpg";
import EmilyM from "../assets/images/miraclechildren/Emily.jpg";
...
import FletcherH from "../assets/images/miraclechildren/Fletcher.jpg";
  ...
  return (
    <ThemeProvider theme={LPtheme}>
      ...
      <LazyLoad height={200} offset={100} once>
        <PageHero
          imageUrl={MiracleFamiliesPic}
          title="Meet our Miracle Families"
        />
      </LazyLoad>
      <Container
        sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            true meaning behind “For All The Right Reasons.” The entire team at
            Dance Marathon is honored and privileged to have these amazing
            families attend Dance Marathon every year and support our students.
          </Typography>
          ...
          <Typography
            ...
            sx={{ color: "text.secondary", marginBottom: 2 }}
          >
            If you would like to become a Children's Miracle Network Hospital
          ...
          <Typography
            ...
            sx={{ color: "text.secondary", marginBottom: 2 }}
          >
            Take a moment to meet the heart and soul of our philanthropy. Our
            Miracle Children are the inspiration for every student who is part
            of DM at UF.
          </Typography>
        </Box>
        <LazyLoad height={200} offset={100} once>
          ...
          >
            {[
              ...
              },
              {
                ...
                title: "Nicolas M.",
                learnMoreLink:
                  "https://docs.google.com/document/d/1CHwYpD0yF4F_IKdCswjTGyzvnejGRviNXFkogg8YsYE/edit?usp=share_link",
                content:
                  "Nick was diagnosed with hypertrophic cardiomyopathy at 2 years old and had an internal defibrillator placed at age 10 to protect him from a dangerous heart rhythm. In January 2017, the defibrillator saved his life by shocking his heart back to a normal beat when it went into a super fast rhythm. Nick had open-heart surgery in 2017 to reduce his heart’s thickness, and since then, his heart function has been great. Nick recently graduated from Santa Fe College and is now 22 years old. He has been involved with Dance Marathon for 12 years!",
              },
              {
                image: NovaleeS,
                title: "Novalee S.",
              ...
              },
              {
                ...
                title: "Wyatt T.",
                learnMoreLink:
                  "https://docs.google.com/document/d/1vHczjGgFFO1fLqvqiZ1FFIDIN-qqVw41A4SAMVV56a0/edit?usp=share_link",
                content:
                  "Wyatt was born with five heart defects, suffered a stroke at 3 months old, and received a heart transplant at 9.5 months old. Thanks to the incredible treatment at UF Health Shands Children’s Hospital, Wyatt is now a happy 15-year-old who loves hunting, fishing, swimming, and all things outdoors. His favorite colors are camo and pink, and he enjoys watching Heartland and Duck Dynasty.",
              },
            ].map((card, index) => (
              <Grid
                item
